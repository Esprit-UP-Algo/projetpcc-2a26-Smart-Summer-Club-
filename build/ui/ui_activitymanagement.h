...
public:
    ...
    QSpacerItem *verticalSpacer_sidebar_2;
...
""));
        ...
        sidebarFrame->setMaximumSize(QSize(60, 16777215));
...
"          "));
        ...
        activitiesButton->setIcon(icon);
        activitiesButton->setCheckable(true);
        activitiesButton->setChecked(true);
        ...
        verticalSpacer_sidebar_2 = new QSpacerItem(20, 638, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Expanding);

        verticalLayout->addItem(verticalSpacer_sidebar_2);
        ...
        activitySearchButton->setIcon(icon1);
        ...
        activityTabWidget->addTab(activityListTab, icon2, QString());
        ...
        activityConfirmButton->setIcon(icon3);
        ...
        activityUpdateButton->setIcon(icon4);
        ...
        activityTabWidget->addTab(activityAddTab, icon3, QString());
        ...
        activityTabWidget->addTab(activityStatisticsTab, icon5, QString());
    ...
    void retranslateUi(QMainWindow *ActivityManagement)
    {
        ...
        userAvatarLabel->setText(QCoreApplication::translate("ActivityManagement", "ST", nullptr));
        userNameLabel->setText(QCoreApplication::translate("ActivityManagement", "Syrine Torkhani", nullptr));
        userRoleLabel->setText(QCoreApplication::translate("ActivityManagement", "Activity Manager", nullptr));
        activitiesButton->setText(QCoreApplication::translate("ActivityManagement", "Activity", nullptr));
